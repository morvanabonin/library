...
import com.senac.allura.rn.BookRN;
 ...
 * @author morvanabonin
 */
public class BookRest extends CrudGenericoRest<Book> {
    
    private final BookRN rn;
    ...
    @Override
    protected Response gerarResponseParaCollection(List<Book> obj) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
